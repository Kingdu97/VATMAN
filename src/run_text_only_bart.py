...
if __name__ == '__main__':
    ...
    parser.add_argument('-checkpoint', default ='/root/VG-GPLMs/src/checkpoint/text_only_bart/last.ckpt', type=str, help='The checkpoint path') # 처음 시작할때는 가져올 checkpoint 없음. default = '' 이거 하면 시작도 안됨. '-checkpoint', default='여기다가 ㄱㄱ', type=str,
