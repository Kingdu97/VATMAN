...
if __name__ == '__main__':
    ...
    parser.add_argument('-checkpoint', default='./lightning_logs/text_only_t5/version_7/checkpoints/epoch=10-step=4499.ckpt', type=str, help='The checkpoint path')
    parser.add_argument('-train_src_path', default='./dataset300/sum_train_tran.tok.5.txt', type=str, help='training input data path (dialogue)')
    parser.add_argument('-train_tgt_path', default='./dataset300/sum_train_desc.tok.5.txt', type=str, help='training output data path (summary)')
    parser.add_argument('-val_src_path', default='./dataset300/sum_valid_tran.tok.5.txt', type=str, help='validatioin input data path (dialogue)')
    parser.add_argument('-val_tgt_path', default='./dataset300/sum_valid_desc.tok.5.txt', type=str, help='validatioin output data path (summary)')
    parser.add_argument('-test_src_path', default='./dataset300/sum_test_tran.tok.5.txt', type=str, help='testing input data path (dialogue)')
    parser.add_argument('-test_tgt_path', default='./dataset300/sum_test_desc.tok.5.txt', type=str, help='testing output data path (summary)')
    parser.add_argument('-image_feature_path', default='./dataset300/video_action_features/', type=str, help='video features path') # 이건 아직 text only 라서 안건들임
    ...
    parser.add_argument('-log_name', default='text_only_t5', type=str, help='lightning log path')
    ...
    parser.add_argument('-num_epochs', type=int, default=10, help='maximun number of training epoches') # 원래는100
