...
if __name__ == '__main__':
    ...
    parser.add_argument('-checkpoint', default ='/root/VG-GPLMs/src/checkpoint/_30_text_only_t5_attntype0_headnums1/last.ckpt', type=str, help='The checkpoint path') # 처음 시작할때는 가져올 checkpoint 없음. default = '' 이거 하면 시작도 안됨. '-checkpoint', default='여기다가 ㄱㄱ', type=str,
    ...
    # set logger
    logger = pl_loggers.TensorBoardLogger(f'./lightning_logs/_30_text_only_t5')   # log_name = 'text_only_t5'    # (f'./lightning_logs/{args.log_name}')

    # save checkpoint
    checkpoint_callback = ModelCheckpoint('./checkpoint/_30_text_only_t5_attntype0_headnums1',
