...
if __name__ == '__main__':
    ...
    parser.add_argument('-model', default='text_only_t5', type=str, help='We have for models to choose, text_only_bart, multi_modal_bart,  text_only_t5 and multi_modal_t5')
    parser.add_argument('-checkpoint', default ='/root/VG-GPLMs/src/checkpoint/text_only_t5_attntype0_headnums1/epoch=17-step=1309.ckpt', type=str, help='The checkpoint path') # 처음 시작할때는 가져올 checkpoint 없음. default = '' 이거 하면 시작도 안됨. '-checkpoint', default='여기다가 ㄱㄱ', type=str,
    ...
    parser.add_argument('-val_save_file', default='/root/VG-GPLMs/src/evaluation/temp_valid_file_text_only_t5', type=str, help='the validation results for each epoch') # 기존은 /temp_valid_file
    ...
    parser.add_argument('-log_name', default='text_only_t5', type=str, help='lightning log path')   # 모델에 따라 바꿔줘야함. lightning log로 저장해줌 
    ...
    parser.add_argument('-batch_size', type=int, default=4, help='batch size for each gpu')     # 원래가 4
    ...
    # set logger
    logger = pl_loggers.TensorBoardLogger(f'./lightning_logs/{args.log_name}')   # log_name = 'text_only_t5'

    # save checkpoint
    checkpoint_callback = ModelCheckpoint('./checkpoint/text_only_t5_attntype0_headnums1',
